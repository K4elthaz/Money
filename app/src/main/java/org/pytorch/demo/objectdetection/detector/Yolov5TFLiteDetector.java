package org.pytorch.demo.objectdetection.detector;
...
import org.pytorch.demo.objectdetection.utils.Recognition;
...
public class Yolov5TFLiteDetector {
    ...
    private final int[] OUTPUT_SIZE = new int[]{1, 10647, 51};
    private Boolean IS_INT8 = false;
    private final float DETECT_THRESHOLD = 0.8f;
    private final float IOU_THRESHOLD = 0.45f;
    private final float IOU_CLASS_DUPLICATED_THRESHOLD = 0.5f;
    private final String MODEL_YOLOV5S = "best12416-fp16.tflite";
//    private final String MODEL_YOLOV5S = "yolov5s-dynamic.tflite";
    private final String MODEL_YOLOV5N =  "best12416-fp16.tflite";
    private final String MODEL_YOLOV5M = "best12416-fp16.tflite";
    private final String MODEL_YOLOV5S_INT8 = "best12416-fp16.tflite";
